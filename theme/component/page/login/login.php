...
<body>
  <section class="login-container ">
    ...
    <div class="back-arrow">
      <a href="../../page/into/into.php"> <i class="fa-solid fa-angle-left"></i></a>
    </div>
    ...
    <div class="login-form-container">
      <form action="/login" method="post" class="login-form">
        ...
        <div class="form-links">
          <a href="../../page/forgot/forgot.php">ลืมรหัสผ่าน?</a>
        </div>
        <div class="form-group">
      ...
      <div class="sign-up-title">
        <h1>ยังไม่มีบัญชี? </h1>
        <a href="../../page/register/register.php">ลงทะเบียนตอนนี้เลย</a>
      </div>
    </div>
  </section>
